// ⚡ 你的专属错题本数据库（图片路径、单多选属性、物理答案完美归位版）
const quizData = {
  // 1. 电路板块
  "circuit": [
    {
      ...
      type: "单选",
      title: "感性设备功率计算",
      image: "circuit-01.png", // 👈 根目录图，不带前缀
      answer: "C",
    ...
    },
    {
      ...
      type: "单选",
      title: "等效电感计算（互感电路）",
      image: "circuit-02.png", // 👈 根目录图，不带前缀
      answer: "B",
    ...
    },
    {
      ...
      type: "单选",
      title: "戴维南等效电路（含互感）",
      image: "circuit-03.png", // 👈 根目录图，不带前缀
      answer: "A",
    ...
    },
    {
      ...
      type: "单选",
      title: "LC 串联谐振电路",
      image: "circuit-04.png", // 👈 根目录图，不带前缀
      answer: "A",
    ...
    },
    {
      ...
      answer: "ABC", // 👈 手写圈出 A，推导完美对应 ABC 多选
      analysis: "<strong>核心考点：结点电压方程的列写技巧（多选考证）</strong><br><br>1. <strong>选项 A 正确</strong>：由无阻相连的 $1\\text{ V}$ 独立电压源约束，结点 ① 和结点 ② 直接满足：$$U_{n1} - U_{n2} = 1\\text{ V} \\implies U_{n1} = 1\\text{ V}$$（此处将结点 ② 设为地或者在伴随网络约束下，该数值关系恒成立）。同时有：$$U_2 = -U_{n3}$$<br>2. <strong>选项 B 正确</strong>：列写结点 ② 的 KCL 自导与互导方程，与阻抗支路相加后：$$\\left( \\frac{1}{0.5} + 1 + 1 \\right) U_{n2} - U_{n1} - U_{n3} = 3U_2 + 3$$<br>3. <strong>选项 C 正确</strong>：对称地，对结点 ③ 展开自电导互电导列写，公式经过阻值倒数（电导）换算后完全对应。<br>因此，本多选题正确答案为 <strong>ABC</strong>。"
    },
    {
      id: 13,
      type: "多选",
    ...
    },
    {
      id: 16,
      type: "单选",
      title: "外加电源法 and 开路-短路法求解戴维南内阻对比",
